...
Q_CONSTINIT static const qt_meta_stringdata_RegisterWindow_t qt_meta_stringdata_RegisterWindow = {
    {
        ...
        QT_MOC_LITERAL(15, 17),  // "onPasswordChanged"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 4),  // "text"
        QT_MOC_LITERAL(39, 15),  // "onCreateAccount"
        QT_MOC_LITERAL(55, 13)   // "onPhantomMode"
    },
    "RegisterWindow",
    "onPasswordChanged",
    "",
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onPasswordChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->onCreateAccount(); break;
